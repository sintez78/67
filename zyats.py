...
def draw_hare(surface, x, y, width, height, color):
    ...
    draw_whisker(surface, x - head_size // 5, whisker_y, whisker_length, 0.3, "left")
    draw_whisker(surface, x - head_size // 5, whisker_y, whisker_length, 0.5, "left")
    draw_whisker(surface, x - head_size // 5, whisker_y - 2, whisker_length, 0.1, "left")

    draw_whisker(surface, x + head_size // 5, whisker_y, whisker_length, 0.3, "right")
    draw_whisker(surface, x + head_size // 5, whisker_y, whisker_length, 0.5, "right")
    draw_whisker(surface, x + head_size // 5, whisker_y - 2, whisker_length, 0.1, "right")
...
clock = pygame.time.finished = False
